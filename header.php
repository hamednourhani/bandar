			...
			<div class="hero">
				<section class="layout">
					...
					<a class="site-link" href="<?php echo get_bloginfo('url'); ?>">
						<img src="<?php	echo get_template_directory_uri(); ?>/images/bandar-logo.png" alt="<?php echo get_bloginfo('name');?>
									"/>
					</a>
			...
			<nav role="navigation" class="main-menu" itemscope="" itemtype="http://schema.org/SiteNavigationElement">
						...
						<div id="responsive-menu" class="responsive-menu">
							...
							<a class="responsive-logo" href="<?php echo get_bloginfo('url'); ?>">
								<img src="<?php
								echo get_template_directory_uri(); ?>/images/bandar-logo.png" alt="<?php echo get_bloginfo('name');
								?>
									"/>
